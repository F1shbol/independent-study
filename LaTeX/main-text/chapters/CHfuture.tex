...
[With deployment (in any state) would come the ability to apply for API access, which would replace the need to rely on an external tool to generate a user's listening history for us]
...
\section{Expanding available timeframes or formats}\label{months}
