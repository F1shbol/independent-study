...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Checked on 25/8/8 and compiles with no errors or warnings. Users must have the latest version of the TeXLive software and
...
%\addbibresource{references.bib,../annotated-bibliography/ISbib1.bib}
%\addbibresource{references.bib}
\addbibresource{../annotated-bibliography/ISbib1.bib}
...
\title{Designing a Web Application to Scrape Data From the Last.fm Platform}
...
% No acknowledgements for now. If I change my mind, it'd be the Guarneras, Will Sieber, and Tamir
...
Thanks also go to Will Sieber, whose suggestion last year to handle my \LaTeX{} locally made all of the formatting a breeze, and to Tamir Hussein, who got me into music tracking in the first place.
...
%
%\begin{fieldsstudy} 
%    \majorfield{Computer Science, B.A.}
%	\minorfield{Political Science Minor}
%    \specialization{Web development [is this valid, or is there a list I should consult?]}
%    %\begin{studieslist}
...
\input{chapters/CH0introduction}
\input{chapters/CHbackground}
\input{chapters/CHfullstack}
\input{chapters/CHdatabases}
\input{chapters/CHdataviz}
\input{chapters/CHimplementation}
\input{chapters/CHfuture}
\input{chapters/CHZconclusion}

%\input{chapters/exintroduction}
%\input{chapters/exchapter1TEX}
%\input{chapters/exchapter2FIG}
%\input{chapters/exchapter3BIB}
